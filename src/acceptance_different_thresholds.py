...
#%%
data_signal = read_data('filename for 0.25 threshold acceptance csv')
data_signal_preprocessed = preprocess_jit(data_signal)
coeff_signal = get_efficiency_coeff_kress(*data_signal_preprocessed, mode='total_unweighted', i_max=5, j_max=5, m_max=5, n_max=5)
func_signal25 = lambda ctl, ctk, phi, q2 : get_efficiency_kress(ctl, ctk, phi, q2, coeff_signal, i_max=5, j_max=5, m_max=5, n_max=5)

data_signal = read_data('filename for 0.50 threshold acceptance csv')
data_signal_preprocessed = preprocess_jit(data_signal)
coeff_signal = get_efficiency_coeff_kress(*data_signal_preprocessed, mode='total_unweighted', i_max=5, j_max=5, m_max=5, n_max=5)
func_signal50 = lambda ctl, ctk, phi, q2 : get_efficiency_kress(ctl, ctk, phi, q2, coeff_signal, i_max=5, j_max=5, m_max=5, n_max=5)

data_signal = read_data('filename for 0.90 threshold acceptance csv')
data_signal_preprocessed = preprocess_jit(data_signal)
coeff_signal = get_efficiency_coeff_kress(*data_signal_preprocessed, mode='total_unweighted', i_max=5, j_max=5, m_max=5, n_max=5)
func_signal90 = lambda ctl, ctk, phi, q2 : get_efficiency_kress(ctl, ctk, phi, q2, coeff_signal, i_max=5, j_max=5, m_max=5, n_max=5)

data_signal = read_data('filename for 0.95 threshold acceptance csv')
data_signal_preprocessed = preprocess_jit(data_signal)
coeff_signal = get_efficiency_coeff_kress(*data_signal_preprocessed, mode='total_unweighted', i_max=5, j_max=5, m_max=5, n_max=5)
func_signal95 = lambda ctl, ctk, phi, q2 : get_efficiency_kress(ctl, ctk, phi, q2, coeff_signal, i_max=5, j_max=5, m_max=5, n_max=5)
