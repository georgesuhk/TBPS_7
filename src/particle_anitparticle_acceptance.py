...
#%%
data_signal = read_data('cleaned_acceptance.csv')

particle_signal = data_signal[data_signal['B0_ID'] == 511]
particle_signal_preprocessed = preprocess_jit(particle_signal)
coeff_signal = get_efficiency_coeff_kress(*particle_signal_preprocessed, mode='total_unweighted', i_max=5, j_max=5, m_max=5, n_max=5)
acceptance_particle = lambda ctl, ctk, phi, q2 : get_efficiency_kress(ctl, ctk, phi, q2, coeff_signal, i_max=5, j_max=5, m_max=5, n_max=5)

antiparticle_signal = data_signal[data_signal['B0_ID'] == -511]
antiparticle_signal_preprocessed = preprocess_jit(antiparticle_signal)
coeff_signal2 = get_efficiency_coeff_kress(*antiparticle_signal_preprocessed, mode='total_unweighted', i_max=5, j_max=5, m_max=5, n_max=5)
acceptance_antiparticle = lambda ctl, ctk, phi, q2 : get_efficiency_kress(ctl, ctk, phi, q2, coeff_signal2, i_max=5, j_max=5, m_max=5, n_max=5)

all_preprocessed = preprocess_jit(data_signal)
coeff_signal3 = get_efficiency_coeff_kress(*all_preprocessed, mode='total_unweighted', i_max=5, j_max=5, m_max=5, n_max=5)
acceptance_all = lambda ctl, ctk, phi, q2 : get_efficiency_kress(ctl, ctk, phi, q2, coeff_signal3, i_max=5, j_max=5, m_max=5, n_max=5)
# %%
