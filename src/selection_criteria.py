...
def filter_B0(
    IPCHI2_OWNPV_thres: float,
    B0_M_thres_low: float,
    B0_M_thres_high: float,
    DIRA_OWNPV_thres: float,
    FDCHI2_OWNPV_thres: float,
    ENDVERTEX_CHI2_thres: float,
    df,
):
    return df[
...
def filter_kstar0(
    Kstar_M_thres: float, vertexchi2_thres: float, FDCHI2_OWNPV_thres: float, df
):
    return df[
        df["Kstar_M"] < Kstar_M_thres
        and df["Kstar_ENDVERTEX_CHI2"] < vertexchi2_thres
        and df[""]
    ]
